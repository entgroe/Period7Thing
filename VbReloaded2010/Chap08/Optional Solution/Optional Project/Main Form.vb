...
Public Class MainForm
    ...
    Private Sub CalcBonus(ByVal totalSales As Double,
             ByRef bonusAmount As Double,
             ByVal bonusRate As Double)
    ...
    Private Sub codeTextBox_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles codeTextBox.Enter
    ...
    Private Sub ClearLabel(ByVal sender As Object, ByVal e As System.EventArgs
                           ) Handles codeTextBox.TextChanged, salesTextBox.TextChanged
