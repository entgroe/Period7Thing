...
Public Class MainForm
    ...
    Private Sub ClearLabel(ByVal sender As Object, ByVal e As System.EventArgs) Handles hoursListBox.SelectedValueChanged,
    ...
    Private Sub numTextBox_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles numTextBox.Enter
    ...
    Private Sub hourlyRadioButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles hourlyRadioButton.Click
    ...
    Private Sub salariedRadioButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles salariedRadioButton.Click
    ...
    Private Sub calcButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles calcButton.Click
        ...
        ' employee number and name to the object
        abcEmployee =
        ...
        If hourlyRadioButton.Checked Then
            ...
            gross = abcEmployee.GetGross(hours, hourRate)
        Else
            ' calculate the gross pay for a salaried employee
            Double.TryParse(salaryListBox.SelectedItem.ToString,
                            annualSalary)
            gross = abcEmployee.GetGross(annualSalary)
        End If

        ' display the gross pay and report, then set the focus
        grossLabel.Text = gross.ToString("C2")
        reportTextBox.Text = reportTextBox.Text &
            abcEmployee.Number.PadRight(6) &
            abcEmployee.EmpName.PadRight(25) &
