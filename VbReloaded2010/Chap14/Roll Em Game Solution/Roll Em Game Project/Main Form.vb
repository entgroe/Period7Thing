...
Public Class MainForm
    ...
    Private Sub rollButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles rollButton.Click
        ...
        ' generate two random numbers from 1 through 6
        ...
        If random1 = random2 Then
            messageLabel.Text = "Congratulations, player " &
                player.ToString
