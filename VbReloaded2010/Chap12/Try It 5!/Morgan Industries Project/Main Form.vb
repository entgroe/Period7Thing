...
Public Class MainForm
    ...
    Private Sub avgButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles avgButton.Click
    ...
    Private Sub highButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles highButton.Click
    ...
    Private Sub dept2Button_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles dept2Button.Click
        ' displays the number of employees in Department 2 

        Dim counter As Integer =
           Aggregate employee In EmployeesDataSet.tblEmploy
           Where employee.Code = 2
           Select employee.Emp_Number Into Count()
