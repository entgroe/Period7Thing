...
Public Class MainForm
    ...
    Private Sub allAscendCodeButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles allAscendCodeButton.Click
    ...
    Private Sub parttimeButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles parttimeButton.Click
    ...
    Private Sub parttimeDescCode_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles parttimeDescCode.Click
        ' selects only part-time records from the dataset and
